...
# Project Info
# ------------------
set(PROJECT_NAME agl_services_mockup)
set(PROJECT_PRETTY_NAME "Test for XDS collector Service")
set(PROJECT_DESCRIPTION "Provide an AGL XDS collector Binding")
set(PROJECT_URL "https://github.com/iotbzh/agl_services_mockup")
...
afb-daemon --port=${AFB_REMPORT} --name=afb-can_emulator --workdir=${CMAKE_BINARY_DIR}/package \
--ldpaths=lib --roothttp=htdocs --token=\"${AFB_TOKEN}\" -vv --ws-server=unix:/tmp/can_emul\
     \
afb-daemon --port=2222 --name=afb-can_app --workdir=${CMAKE_BINARY_DIR}/package \
--ldpaths=lib --roothttp=htdocs --token=\"${AFB_TOKEN}\" -vv --ws-client=unix:/tmp/can_emul")
